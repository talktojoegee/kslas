...
@Component({
  selector: 'app-objected-bills',
  imports: [RouterLink, CommonModule, CardComponent, TableModule, Button,
    IconFieldModule, InputIconModule, PaginatorModule],
  templateUrl: './objected-bills.component.html',
  styleUrl: './objected-bills.component.scss'
})
export class ObjectedBillsComponent implements OnInit{
