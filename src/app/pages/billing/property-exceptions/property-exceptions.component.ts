...
@Component({
  selector: 'app-property-exceptions',
  ...
  templateUrl: './property-exceptions.component.html',
  styleUrl: './property-exceptions.component.scss',
  providers:[MessageService]
})
export class PropertyExceptionsComponent {


  pageTitle: string = "Property Exceptions";
  listForm!:FormGroup;
