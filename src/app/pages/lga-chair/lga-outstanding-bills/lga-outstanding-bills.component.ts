...
@Component({
  selector: 'app-lga-outstanding-bills',
  imports: [RouterLink, CommonModule, CardComponent, TableModule, Button,
    IconFieldModule, InputIconModule, PaginatorModule],
  templateUrl: './lga-outstanding-bills.component.html',
  styleUrl: './lga-outstanding-bills.component.scss'
})
export class LgaOutstandingBillsComponent implements OnInit {
